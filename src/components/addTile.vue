<template>
    <div class="tile" @click="addTileModal">
        +
    </div>
    <div class="modal" :class="{ open: isActive }">
        <form @submit.prevent="addTileToDB">
            coord: <input type="text" v-model="form.coordinate" name="coordinate" id="addtiletitle"><br>
            title: <input type="text" v-model="form.title" name="title" id="addtiletitle"><br>
            description: <input type="text" v-model="form.description" name="description" id="addtiletitle"><br>
