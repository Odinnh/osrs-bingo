 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lC{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(uC(n)){const i=n.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(n=>n).join(" ")}}function uC(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const oh="@firebase/app",dm="0.9.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ym(t,...e){throw jf(t,...e)}function Bf(t,...e){return jf(t,...e)}function JC(t,e,n){const i=Object.assign(Object.assign({},QC()),{[e]:n});return new ds("auth","Firebase",i).create(e,{appName:t.name})}function jf(t,...e){if(typeof t!="string"){const n=e[0],i=[...e.slice(1)];return i[0]&&(i[0].appName=t.name),t._errorFactory.create(n,...i)}return hv.create(t,...e)}function we(t,e,...n){if(!t)throw jf(e,...n)}function js(t){const e="INTERNAL ASSERTION FAILED: "+t;throw Ka(e),new Error(e)}function ac(t,e){t||js(e)}function ZC(){return _m()==="http:"||_m()==="https:"}function _m(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vm=new Map;function Ui(t){ac(t instanceof Function,"Expected a class definition");let e=vm.get(t);return e?(ac(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,vm.set(t,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fu(t,e,n){return`firebase:${t}:${e}:${n}`}class Fr{constructor(e,n,i){this.persistence=e,this.auth=n,this.userKey=i;const{config:r,name:s}=this.auth;this.fullUserKey=fu(this.userKey,r.apiKey,s),this.fullPersistenceKey=fu("persistence",r.apiKey,s),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?Lr._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,i="authUser"){if(!n.length)return new Fr(Ui(bm),e,i);const r=(await Promise.all(n.map(async l=>{if(await l._isAvailable())return l}))).filter(l=>l);let s=r[0]||Ui(bm);const o=fu(i,e.config.apiKey,e.name);let a=null;for(const l of n)try{const u=await l._get(o);if(u){const h=Lr._fromJSON(e,u);l!==s&&(a=h),s=l;break}}catch{}const c=r.filter(l=>l._shouldAllowMigration);return!s._shouldAllowMigration||!c.length?new Fr(s,e,i):(s=c[0],a&&await s._set(o,a.toJSON()),await Promise.all(n.map(async l=>{if(l!==s)try{await l._remove(o)}catch{}})),new Fr(s,e,i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */new Uo(5e3,15e3);var Im="@firebase/auth",Cm="0.23.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hh=new Fo("@firebase/app-check");function Am(t,e){return tv()?KS(t,e).catch(n=>{hh.warn(`Failed to write token to IndexedDB. Error: ${n}`)}):Promise.resolve()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qm=10*1e3,Ok=30*1e3,Pk=5*60*1e3;class Mk{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new Dk(e);const i=Qm+(Ok-Qm)*Math.random();Hs(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),n={};let i=!1;Jt(e,(r,s)=>{s>0&&ei(this.statsToReport_,r)&&(n[r]=s,i=!0)}),i&&this.server_.reportStats(n),Hs(this.reportStats_.bind(this),Math.floor(Math.random()*2*Pk))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function h0(t,e){return g0(e,t)}function $k(t,e,n,i,r){P(i>t.lastWriteId,"Stacking an older write on top of newer ones"),r===void 0&&(r=!0),t.allWrites.push({path:e,snap:n,writeId:i,visible:r}),r&&(t.visibleWrites=Ws(t.visibleWrites,e,n)),t.lastWriteId=i}function Bk(t,e){for(let n=0;n<t.allWrites.length;n++){const i=t.allWrites[n];if(i.writeId===e)return i}return null}function jk(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);P(n>=0,"removeWrite called with nonexistent writeId.");const i=t.allWrites[n];t.allWrites.splice(n,1);let r=i.visible,s=!1,o=t.allWrites.length-1;for(;r&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&zk(a,i.path)?r=!1:an(i.path,a.path)&&(s=!0)),o--}if(r){if(s)return Hk(t),!0;if(i.snap)t.visibleWrites=Jm(t.visibleWrites,i.path);else{const a=i.children;Jt(a,c=>{t.visibleWrites=Jm(t.visibleWrites,st(i.path,c))})}return!0}else return!1}function zk(t,e){if(t.snap)return an(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&an(st(t.path,n),e))return!0;return!1}function Hk(t){t.visibleWrites=f0(t.allWrites,Kk,Se()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function Kk(t){return t.visible}function f0(t,e,n){let i=fn.empty();for(let r=0;r<t.length;++r){const s=t[r];if(e(s)){const o=s.path;let a;if(s.snap)an(n,o)?(a=Qt(n,o),i=Ws(i,a,s.snap)):an(o,n)&&(a=Qt(o,n),i=Ws(i,Se(),s.snap.getChild(a)));else if(s.children){if(an(n,o))a=Qt(n,o),i=Xm(i,a,s.children);else if(an(o,n))if(a=Qt(o,n),ue(a))i=Xm(i,Se(),s.children);else{const c=qr(s.children,fe(a));if(c){const l=c.getChild(xe(a));i=Ws(i,Se(),l)}}}else throw fs("WriteRecord should have .snap or .children")}}return i}function d0(t,e,n,i,r){if(!i&&!r){const s=hr(t.visibleWrites,e);if(s!=null)return s;{const o=pi(t.visibleWrites,e);if(wh(o))return n;if(n==null&&!bh(o,Se()))return null;{const a=n||Ee.EMPTY_NODE;return Yr(o,a)}}}else{const s=pi(t.visibleWrites,e);if(!r&&wh(s))return n;if(!r&&n==null&&!bh(s,Se()))return null;{const o=function(l){return(l.visible||r)&&(!i||!~i.indexOf(l.writeId))&&(an(l.path,e)||an(e,l.path))},a=f0(t.allWrites,o,e),c=n||Ee.EMPTY_NODE;return Yr(a,c)}}}function Wk(t,e,n){let i=Ee.EMPTY_NODE;const r=hr(t.visibleWrites,e);if(r)return r.isLeafNode()||r.forEachChild(Et,(s,o)=>{i=i.updateImmediateChild(s,o)}),i;if(n){const s=pi(t.visibleWrites,e);return n.forEachChild(Et,(o,a)=>{const c=Yr(pi(s,new Me(o)),a);i=i.updateImmediateChild(o,c)}),Zm(s).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const s=pi(t.visibleWrites,e);return Zm(s).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function qk(t,e,n,i,r){P(i||r,"Either existingEventSnap or existingServerSnap must exist");const s=st(e,n);if(bh(t.visibleWrites,s))return null;{const o=pi(t.visibleWrites,s);return wh(o)?r.getChild(n):Yr(o,r.getChild(n))}}function Gk(t,e,n,i){const r=st(e,n),s=hr(t.visibleWrites,r);if(s!=null)return s;if(i.isCompleteForChild(n)){const o=pi(t.visibleWrites,r);return Yr(o,i.getNode().getImmediateChild(n))}else return null}function Yk(t,e){return hr(t.visibleWrites,e)}function Qk(t,e,n,i,r,s,o){let a;const c=pi(t.visibleWrites,e),l=hr(c,Se());if(l!=null)a=l;else if(n!=null)a=Yr(c,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],h=o.getCompare(),f=s?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let d=f.getNext();for(;d&&u.length<r;)h(d,i)!==0&&u.push(d),d=f.getNext();return u}else return[]}function Xk(){return{visibleWrites:fn.empty(),allWrites:[],lastWriteId:-1}}function Eh(t,e,n,i){return d0(t.writeTree,t.treePath,e,n,i)}function p0(t,e){return Wk(t.writeTree,t.treePath,e)}function eg(t,e,n,i){return qk(t.writeTree,t.treePath,e,n,i)}function gc(t,e){return Yk(t.writeTree,st(t.treePath,e))}function Jk(t,e,n,i,r,s){return Qk(t.writeTree,t.treePath,e,n,i,r,s)}function td(t,e,n){return Gk(t.writeTree,t.treePath,e,n)}function m0(t,e){return g0(st(t.treePath,e),t.writeTree)}function g0(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function l2(t){return t!==void 0}function ry(t,e,n,i){if(i<e)throw iy(`Invalid value for '${t}'. Expected ${e} or greater.`);if(i>n)throw iy(`Invalid value for '${t}'. Expected ${n} or less.`)}function u2(t){const e=encodeURIComponent;let n="?";for(const i in t)if(t.hasOwnProperty(i)){const r=e(i)+"="+e(t[i]);n=n+r+"&"}return n=n.slice(0,-1),n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
